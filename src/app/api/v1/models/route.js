  ...
  if (connections.length === 0) {
    ...
    for (const [providerId, conn] of activeConnectionByProvider.entries()) {
      ...
      for (const modelId of mergedModelIds) {
        ...
        const syncedKind = syncedModelKindById.get(modelId);
        const kind = customKind || liveKind || staticModelKindById.get(modelId) || syncedKind || inferKindFromUnknownModelId(modelId);
